...
public class EnergyFrag extends androidx.fragment.app.Fragment implements ProblemChooseListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDatabaseReference.child("problems").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    int i=0;
                    ProblemTrack listTrack=dataSnapshot.child("EnergyManagement").getValue(ProblemTrack.class);
                ...
                mAdapter=new ListAdapter(list,EnergyFrag.this,((ProblemActivity)getActivity()).toContinue);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_energy, container, false);
    ...
    public class ListAdapter extends RecyclerView.Adapter<EnergyFrag.ListAdapter.ViewHolder> {
        ...
        public EnergyFrag.ListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.problem_statement_card, parent, false);

            EnergyFrag.ListAdapter.ViewHolder viewHolder = new EnergyFrag.ListAdapter.ViewHolder(view);
            return viewHolder;
        }

        public void onBindViewHolder(EnergyFrag.ListAdapter.ViewHolder holder, final int position) {
