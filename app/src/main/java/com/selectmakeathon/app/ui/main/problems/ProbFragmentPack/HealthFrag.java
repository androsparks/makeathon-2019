 ...
 */
public class HealthFrag extends androidx.fragment.app.Fragment implements ProblemChooseListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDatabaseReference.child("problems").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    int i = 0;
                    ProblemTrack listTrack = dataSnapshot.child("HealthCare").getValue(ProblemTrack.class);
                ...
                mAdapter = new ListAdapter(list,HealthFrag.this);
    ...
    //Adapter Class
    public class ListAdapter extends RecyclerView.Adapter<HealthFrag.ListAdapter.ViewHolder> {
        ...
        public HealthFrag.ListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.problem_statement_card, parent, false);

            HealthFrag.ListAdapter.ViewHolder viewHolder = new HealthFrag.ListAdapter.ViewHolder(view);
            return viewHolder;
        }

        public void onBindViewHolder(HealthFrag.ListAdapter.ViewHolder holder, final int position) {
