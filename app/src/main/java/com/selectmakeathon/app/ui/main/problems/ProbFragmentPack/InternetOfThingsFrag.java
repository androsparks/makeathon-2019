 ...
 */
public class InternetOfThingsFrag extends androidx.fragment.app.Fragment implements ProblemChooseListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mDatabaseReference.child("problems").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                try {
                    int i=0;
                    ProblemTrack listTrack=dataSnapshot.child("IoT").getValue(ProblemTrack.class);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view= inflater.inflate(R.layout.fragment_internet_of_things, container, false);
    ...
    public class ListAdapter extends RecyclerView.Adapter<InternetOfThingsFrag.ListAdapter.ViewHolder> {
        ...
        public InternetOfThingsFrag.ListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.problem_statement_card, parent, false);

            InternetOfThingsFrag.ListAdapter.ViewHolder viewHolder = new InternetOfThingsFrag.ListAdapter.ViewHolder(view);
            return viewHolder;
        }

        public void onBindViewHolder(InternetOfThingsFrag.ListAdapter.ViewHolder holder, final int position) {
